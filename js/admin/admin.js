...
const closeAddModal = document.querySelector('#admin-add-modal-btns__close-btns')
const addDoneBtn = document.querySelector('#admin-add-modal-btns__add-done-btn')
...
const addDescriptionInput = document.querySelector('#admin-add-description-input')
...
async function onAddDoneBtnClicked() {
  if (
    ...
    const file = await getBase64(addFileInput.files[0])
    .then(base64 => {
      return base64
    })
...
const closeEditModal = document.querySelector('#admin-edit-modal-btns__close-btns')
const editDoneBtn = document.querySelector('#admin-edit-modal-btns__edit-done-btn')
...
const editDescriptionInput = document.querySelector('#admin-edit-description-input')
...
async function onEditDoneBtnClicked() {
  if (
    ...
    const file = await getBase64(editFileInput.files[0])
    .then(base64 => {
      return base64
    })
