  ...
  detailedItem.innerHTML = /*html*/`
    ...
    <section class="detailedItem_item">
      ...
      <div class="item_rightSide">
        ...
        <div>
          <a href="javascript:void(0)" class="item_name"></a>
        </div>

        <p class="item_title">제품</p>
        <small class="item_KORtitle">제품이름(예시)</small>
        ...
        <div class="item_price">
          ...
          <span class="price_nowPrice">56,000(예시)</span>
